...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_DEADLINE_DESC + ADDRESS_DESC_AMY, Deadline.MESSAGE_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditTaskDescriptor descriptor = new EditTaskDescriptorBuilder().withName(VALID_NAME_AMY)
                .withDeadline(VALID_DEADLINE_BOB).withAddress(VALID_ADDRESS_AMY)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + DEADLINE_DESC_BOB + ADDRESS_DESC_AMY;
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_TASK;
        String userInput = targetIndex.getOneBased() + DEADLINE_DESC_AMY + ADDRESS_DESC_AMY
                + TAG_DESC_FRIEND + DEADLINE_DESC_AMY + ADDRESS_DESC_AMY + TAG_DESC_FRIEND
                + DEADLINE_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND;
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + INVALID_DEADLINE_DESC + ADDRESS_DESC_BOB
                + DEADLINE_DESC_BOB;
