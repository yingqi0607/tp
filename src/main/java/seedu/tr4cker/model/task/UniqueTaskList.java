 ...
 * updating of tasks uses Task#isSameTask(Task) for equality so as to ensure that the task being added
 * or updated is unique in terms of identity in the UniqueTaskList. However, the removal of a task uses
 * n#equals(Object) so as to ensure that the task with exactly the same fields will be removed.
 *
