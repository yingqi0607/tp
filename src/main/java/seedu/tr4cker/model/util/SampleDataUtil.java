...
public class SampleDataUtil {
    public static Task[] getSampleTasks() {
        return new Task[] {
            new Task(new Name("CS1101S Mission"), new Deadline("2021-10-20 1800"), new CompletionStatus(100),
                new TaskDescription("A very fun mission"),
                getTagSet("CS1101S", "Mission", "Fun")),
            new Task(new Name("CS1101S Quiz"), new Deadline("2021-09-30 2359"), new CompletionStatus(0),
                new TaskDescription("A quiz that's too hard for me"),
                getTagSet("CS1101S", "Quiz", "2Hard4Me")),
            new Task(new Name("CS2100 MidTerms"), new Deadline("2021-10-03 1200"), new CompletionStatus(20),
                new TaskDescription("Need do cheat sheet"),
                getTagSet("cheatSheetsFTW")),
            new Task(new Name("CS2103T Project"), new Deadline("2021-09-21 1500"), new CompletionStatus(50),
                new TaskDescription("I love project work"),
                getTagSet("CS2103T", "EthanSGKK")),
            new Task(new Name("CS2101 OP2"), new Deadline("2021-10-10 1010"), new CompletionStatus(0),
                new TaskDescription("All the best Good Luck"),
                getTagSet("CS2101", "20Percent")),
            new Task(new Name("CS1231S Graded Assignment"), new Deadline("2021-12-25 0000"), new CompletionStatus(1),
