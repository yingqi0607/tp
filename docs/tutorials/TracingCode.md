...
Recall from the User Guide that the `edit` command has the format: `edit INDEX [n/NAME] [d/DEADLINE] [e/EMAIL] [a/ADDRESS] [t/TAG]…​` For this tutorial we will be issuing the command `edit 1 n/Alice Yeoh`.
